...
public class AES {
    ...
    private static final int    SALT_LENGTH     = 16;                    // in
                                                                          // bytes
    private static final int    AUTH_KEY_LENGTH = 8;                     // in
                                                                          // bytes
    ...
    public static void main(String[] args) throws InvalidKeyLengthException,
            StrongEncryptionNotAvailableException, IOException,
            InvalidPasswordException, InvalidAESStreamException {
        long begin = System.currentTimeMillis(); 
        // encrypt(256,"19891199abc".toCharArray(),Files.newInputStream(Paths.get("f:/t/netty.tar.bz2")),
        // Files.newOutputStream(Paths.get("f:/t/new.tar.bz2"),StandardOpenOption.CREATE_NEW));
        decrypt("19891199abc".toCharArray(), Files.newInputStream(Paths
                .get("f:/t/new.tar.bz2")), Files.newOutputStream(
                Paths.get("f:/t/decrypt.tar.bz2"),
